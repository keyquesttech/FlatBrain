...
const DATA_FILES = ['draft.json', 'history.json', 'invoices.json', 'rent.json', 'payments.json', 'settings.json', 'password.txt', 'backup-config.json', 'reboot-config.json', 'temp-history.json'];
