...
const DATA_FILES = ['draft.json', 'history.json', 'invoices.json', 'password.txt', 'backup-config.json', 'reboot-config.json'];
const RESTORE_FILES = ['draft.json', 'history.json', 'invoices.json', 'password.txt'];
