...
const draft = normalizeDraft({
  ...
  bills: [
    ...
    { id: 'b2', thing: 'Water', amount: '40', discountPercent: '50', discountedFrom: 'flatmate2' }
  ],
  flatmate1Extras: [{ id: 'm1', thing: 'Bulbs', packs: '2', price: '15', percent: '50', percentOwn: true, unitPriced: true }],
  flatmate2Extras: [{ id: 'r1', thing: 'Cleaner', packs: '1', price: '6', percent: '50', percentOwn: true, unitPriced: true }],
  flatmate1Discounts: [{ id: 'd1', thing: 'Credit', type: 'amount', value: '5' }]
});
const history = [{ id: 'h1', period: '2026-06', timestamp: 1, bills: [{ id: 'b', thing: 'Rent', amount: '850' }], flatmate1Extras: [] }];
...
check(prev.includes('due-card-summary-flatmate2'), 'flatmate cards intact');

// Extras list: labels row + unit-price hint
const extras = renderToStaticMarkup(
  <ExtrasInputList extras={draft.flatmate1Extras} onAdd={() => {}} onUpdate={() => {}} onRemove={() => {}} percentPayer="M" percentOther="R" />
);
