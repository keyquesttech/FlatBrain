...
import { appConfirm, appToast } from './Dialog';
...
// The Logs view of the Settings app: the server's record of everything that
// happened — log-ins, saves, settings changes, backups and reboots. Read-only
// apart from retention and the clear button; the server writes the events.
