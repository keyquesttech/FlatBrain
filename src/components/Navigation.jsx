...
export default function Navigation({ activeTab, names = DEFAULT_NAMES, showTabs = true, appLabel }) {
  ...
  const tabs = [
    ...
    { id: 'flatmate1', to: '/billsplitter/flatmate1', label: names.flatmate1?.trim() || 'Flatmate 1' },
    { id: 'flatmate2', to: '/billsplitter/flatmate2', label: names.flatmate2?.trim() || 'Flatmate 2' }
  ];
