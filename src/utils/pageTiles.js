...
// (whatever pages Settings ticked onto it). Adding a future app = one
// entry here plus its route and hub key.
export const PAGE_TILES = [
  ...
  },
  {
    key: 'flatmate1',
    appTile: false,
    name: `${DEFAULT_NAMES.flatmate1}'s bills page`,
  ...
  },
  {
    key: 'flatmate2',
    appTile: false,
    name: `${DEFAULT_NAMES.flatmate2}'s bills page`,
